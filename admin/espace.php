...
// Vérification connexion + rôle administratif
if (!isset($_SESSION['id_users']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'administrateur') {
    // Redirection vers la page login si non connecté ou rôle incorrect
...
if (!$user) {
    // Si l'utilisateur n'existe pas, on détruit la session et redirige
    session_destroy();
    header("Location: " . BASE_URL . "login.php");
    exit();
}
...
<head>
    ...
    <title>Espace administratif ECE Ciné</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <p>Vous êtes actuellement connecté comme administratif.</p>
    </div>
